...
@IQTable(name="t_ads")
@IQIndexes({@IQIndex(name="FK_shopId", type=IndexType.UNIQUE, value={ "FK_shopId", "url" }), @IQIndex(name="idx_url", value={ "url" }), @IQIndex(name="FK_shopId_Index", value={ "FK_shopId" })})
